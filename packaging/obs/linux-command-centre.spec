...
# in OBS's sandboxed build chroot without network (npm install + the
# Electron binary download need it) - this repackages the tarball already
# built by .github/workflows/release.yml, fetched by the `download_url`
# _service before the build runs. See ../README.md and ./README.md.
%description
